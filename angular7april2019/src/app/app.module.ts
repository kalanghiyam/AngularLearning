...
@NgModule(
  {
    declarations: [ RootComponent, 
                    ...
                    TaskComponent,
                    InbuiltComponent, 
                    SortstringPipe, SortnumPipe, ConsumeserviceComponent, Consumeservice2Component, RemoteComponent, UpdateFriendComponent, ParentComponent, ChildComponent, AnimateComponent, Delete1Component, Delete2Component, Delete3Component, Delete4Component, Delete6Component, BootstrapComponent],
